...
async function run() {
  try {
    ...
    //collection init
    const serviceCollection = client.db('fastDB').collection('services');
    const bookingCollection = client.db('fastDB').collection('booking');
    ...
    app.get('/services/:id',async(req,res)=>{
        ...
        const option = {
            projection: { _id: 0, service_id:1, title: 1, img: 1 },
        }
